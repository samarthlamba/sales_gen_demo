...
export default function CustomerSuccessDashboard() {
  ...
  const [customUrl, setCustomUrl] = useState("dashboard-renewals-q2-2025")
  const [sharePermission, setSharePermission] = useState("view")
  const [expirationOption, setExpirationOption] = useState("never")
  const [selectedTeams, setSelectedTeams] = useState<string[]>(["customer-success"])
  const [selectedUsers, setSelectedUsers] = useState<string[]>([])

  // Mock teams and users for sharing
  const teams = [
    { id: "customer-success", name: "Customer Success", members: 12 },
    { id: "sales", name: "Sales", members: 8 },
    { id: "executive", name: "Executive Team", members: 5 },
    { id: "product", name: "Product", members: 15 },
    { id: "engineering", name: "Engineering", members: 24 },
  ]

  const users = [
    { id: "alex", name: "Alex Johnson", email: "alex@company.com", role: "CSM Lead" },
    { id: "sarah", name: "Sarah Miller", email: "sarah@company.com", role: "CSM" },
    { id: "michael", name: "Michael Chen", email: "michael@company.com", role: "CSM" },
    { id: "emily", name: "Emily Wong", email: "emily@company.com", role: "CSM" },
    { id: "james", name: "James Wilson", email: "james@company.com", role: "Sales Director" },
    { id: "lisa", name: "Lisa Park", email: "lisa@company.com", role: "VP Customer Success" },
    { id: "robert", name: "Robert Taylor", email: "robert@company.com", role: "CEO" },
  ]
  ...
  const customers = [
    {
      ...
      csm: "Alex Johnson",
      history: [
        { date: "2024-04-10", event: "Quarterly Business Review" },
        { date: "2024-04-15", event: "Feature usage declined by 15%" },
      ],
  ...
  const integrations = [
    ...
    { id: "zendesk", name: "Zendesk", category: "Support", selected: false },
    ...
    <div className={`p-4 min-h-full flex flex-col ${editMode ? "edit-mode" : ""}`}>
        ...
        <DialogContent className="bg-zinc-900 border-zinc-800 text-white max-w-lg p-0 gap-0">
          <div className="p-6 pb-0">
            <DialogHeader className="pb-4">
              <DialogTitle className="text-xl">Share dashboard</DialogTitle>
              <DialogDescription className="text-zinc-400">Share this dashboard with others</DialogDescription>
            </DialogHeader>
          </div>
          ...
          <div className="px-6 py-4 space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="default" className="bg-white text-black hover:bg-zinc-200 shrink-0">
                  Add
                </Button>
              </div>
            </div>
            ...
            <div className="bg-zinc-800 p-4 rounded-md">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Dashboard link</span>
                </div>
                <Button variant="ghost" size="sm" className="h-8 text-xs">
                  <Copy className="h-3 w-3 mr-1" /> Copy
                </Button>
              </div>
              <div className="bg-zinc-900 border border-zinc-700 rounded-md px-3 py-2 text-sm text-zinc-400 overflow-hidden text-ellipsis whitespace-nowrap">
                https://company.dashboard.com/dashboard-renewals-q2-2025
              </div>
            </div>

            {/* Custom URL */}
            <div>
              <Label htmlFor="custom-url" className="text-sm font-medium mb-2 block">
                Custom URL
              </Label>
              <div className="flex items-center">
                <div className="bg-zinc-800 px-3 py-2 rounded-l-md border-y border-l border-zinc-700 text-zinc-500 text-sm whitespace-nowrap">
          ...
          <DialogFooter className="bg-zinc-900 px-6 py-4 border-t border-zinc-800 flex justify-end gap-2">
            <Button
              variant="outline"
            ...
            <Button className="bg-white text-black hover:bg-zinc-200" onClick={handleShare}>
              {shareSuccess ? (
                <>
                  <CheckCircle className="h-4 w-4 mr-2" /> Shared
                </>
              ) : (
                <>
      ...
      {selectedCustomer && (
        <Dialog open={!!selectedCustomer} onOpenChange={(open) => !open && setSelectedCustomer(null)}>
          <DialogContent className="bg-zinc-900 border-zinc-800 text-white max-w-5xl max-h-[90vh] overflow-hidden">
            <DialogHeader className="border-b border-zinc-800 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <h2 className="text-xl font-semibold">{selectedCustomer.customer}</h2>
                  <Badge
                    variant="outline"
                    className={`flex items-center gap-1 ${getStatusColor(selectedCustomer.status)}`}
                  >
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-lg font-bold ${getRiskColor(selectedCustomer.riskScore)}`}>
                    {selectedCustomer.riskScore}/100
                  </span>
                </div>
              </div>
              <DialogDescription className="text-zinc-400 mt-2">
                Customer since January 2024 • Managed by {selectedCustomer.csm}
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter className="border-t border-zinc-800 pt-4">
              <div className="flex w-full gap-2">
                <Button className="flex-1 bg-white text-black hover:bg-zinc-200" onClick={handleGenerateInsight}>
                  Generate Insight
                </Button>
                <Button
                  variant="outline"
        ...
        {dialogState.type === "send-alert" && (
          <DialogContent className="bg-zinc-900 border-zinc-800 text-white">
            <DialogHeader>
              ...
              <DialogDescription className="text-zinc-400">
                Set up automated alerts for {dialogState.customer || "the selected customer"}.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Select defaultValue="risk">
                  ...
                  <SelectContent className="bg-zinc-900 border-zinc-800 text-white">
                    ...
                    <SelectItem value="usage">Usage Drop</SelectItem>
                    <SelectItem value="sentiment">Negative Sentiment Detected</SelectItem>
                    <SelectItem value="activity">Inactivity</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
